      ...
      <section className="relative w-full min-h-[35vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-6 text-center">
          <h1 className="font-serif text-white text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Decades of Strategic Insight. A Lifetime of Technical Precision.
          </h1>
          <p className="font-serif text-white/80 text-lg">
            Merging 15 years of multi-state billing expertise with 30 years of enterprise data engineering.
          </p>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="text-center mb-14">
            <h1 className="font-serif text-4xl lg:text-5xl font-bold text-[#242424] mb-2">
OUR STORY            </h1>
      ...
      <section className="py-20 bg-[#f8f6f2]">
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white border border-[#e7e3da] rounded-xl p-8 shadow-sm">
              <h3 className="font-serif text-xl font-semibold text-[#242424] mb-4">
                The Technical Architect (30+ Years)
              </h3>

              <ul className="space-y-3 text-[#807e78] leading-relaxed">
                <li>• Masters in Computer Science with a focus on high-integrity data pipelines.</li>
                <li>• 15 years at the largest US Payer, managing enterprise-level database operations for Audit, Fraud and Abuse, and Employer Claims Reporting.</li>
      ...
      <section className="py-24">
        <div className="container-wide max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#7a7974] mb-6">
            We understand the administrative challenges of modern medicine because we see them every day.
          </p>
        ...
        <div className="container-wide max-w-3xl mx-auto">
          ...
          <div className="flex gap-4 p-8 bg-white border border-[#e7e3da] rounded-xl shadow-sm items-start">
            ...
            <p className="text-[#807e78] text-lg leading-relaxed">
              ...
              <br />
              "At our core, we believe that financial transparency is the backbone of a successful practice. My goal has always been to bring the highest level of data integrity and professional reliability to the medical billing world, so providers can focus on what they do best."
            </p>
          </div>
